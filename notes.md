...
when you load JSON into python, they turn into lists and dicts
to grab each value in the JSON file, u have to use indexes like data["outer_key"]["inner_key"]


Stack
Airflow (Docker) — orchestrates daily data pulls
YouTube API v3 — ingests video metadata + comments
PySpark — flattens/processes raw JSON
